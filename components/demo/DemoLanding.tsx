...
/* ΓöÇΓöÇΓöÇ ROI Calculator ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
...
/* ΓöÇΓöÇΓöÇ Onboarding Section ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
            ...
            <section className="relative pt-32 pb-20 px-6 overflow-hidden min-h-[80vh] flex items-center">
                ...
                <div className="relative mx-auto max-w-5xl text-center">
                    ...
                    <p className={`text-base md:text-lg max-w-2xl mx-auto mb-12 leading-relaxed ${f.animations ? "text-white/60" : "text-white/40"}`}>
                        Comisi├│n desde 6%, se paga al escriturar. Exclusiva de 60 d├¡as con dedicaci├│n total.
                    </p>
                ...
                <section className="px-6 py-16 border-t border-white/5">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                { name: "Familia Garc├¡a", text: "Vendieron nuestra casa en 18 d├¡as. Incre├¡ble experiencia.", stars: 5 },
                                { name: "Ing. Roberto M.", text: "El portal del propietario me mantuvo informado en todo momento.", stars: 5 },
                                { name: "Dra. Sof├¡a L.", text: "Profesionalismo y tecnolog├¡a. Los recomiendo al 100%.", stars: 5 },
                            ].map((t, i) => (
                                <motion.div
                                    key={i}
                                    initial={{ opacity: 0, y: 20 }}
