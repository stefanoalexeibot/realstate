            ...
            <div className="relative aspect-[4/3] md:aspect-video max-w-[800px] mx-auto flex items-center justify-center overflow-visible px-4">
                ...
                <div className="relative z-10">
                    <motion.div
                        ...
                        className="w-16 h-16 sm:w-20 md:w-32 md:h-32 rounded-full bg-cima-gold/10 border border-cima-gold/30 backdrop-blur-3xl flex items-center justify-center relative shadow-[0_0_50px_rgba(234,179,8,0.2)]"
                    >
                        <div className="absolute inset-0 rounded-full animate-ping bg-cima-gold/20 opacity-20" style={{ animationDuration: '3s' }} />
                        <Zap className="h-5 w-5 sm:h-6 sm:w-6 md:h-10 md:w-10 text-cima-gold" />
                    ...
                    >
                        <div className="flex flex-col items-center gap-1 sm:gap-2 md:gap-4">
                            ...
                            <div className="text-center max-w-[60px] md:max-w-[120px] transition-all duration-500 md:group-hover:translate-y-[-4px]">
                                <p className="text-[7px] md:text-[11px] font-black text-cima-text uppercase tracking-wider mb-0.5 md:mb-1 leading-tight">{node.title}</p>
