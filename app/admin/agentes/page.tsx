...
const EMPTY: { name: string; phone: string; email: string; specialty: "venta" | "renta" | "both" } = { name: "", phone: "", email: "", specialty: "both" };
...
export default function AgentesPage() {
  ...
  function openEdit(a: Agente) {
    setEditing(a);
    setForm({ name: a.name, phone: a.phone ?? "", email: a.email ?? "", specialty: a.specialty });
    setError(null);
    setShowForm(true);
  }
